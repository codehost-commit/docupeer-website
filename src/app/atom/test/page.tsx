...
const TEST_REQUEST = {
  ...
  extraNotes:
    "Stress-test compact high detail in one reliable request. Use clean LaTeX for every equation, vector, derivative, integral, limit, exponent, subscript, matrix, and symbol. Include one useful diagram and a complete teacher answer key.",
      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-3xl flex-col items-center justify-center">
        <div className="w-full border-y border-[#ded8cc] py-10 text-center sm:py-14">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-7 text-[#606978]">
            Calculus III · 4 questions · 1 diagram · compact high detail
          </p>
          <button
            type="button"
            onClick={runTest}
